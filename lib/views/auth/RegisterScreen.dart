...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  _handleRegister() async {
    ...
    if (name.isEmpty) {
      ...
      dynamic response =
          await AuthController.registerUser(name, email, password,"${contrycode}${_numberController!.text}",selectedCategory,selectedShop,licencePic,profilePic,carnumber);
      ...
      if (authType == AuthType.VERIFIED) {
       ...
       if (authType == AuthType.LOGIN) {
        ...
        showMessage(message: 'err${response.errorText.toString()}');
      }
