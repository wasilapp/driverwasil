        ...
        body: Column(children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              print(
                  "2222222222222${mySubcategoryShops.length}2222222222222222");
            ...
            children: [
              ...
              Card(
                ...
                child: Container(
                    ...
                    height: 90,
                    child: Image.network(
                      Api.BASE_URL.replaceAll('public/', '') + image,
                    )
                    // CachedNetworkImage(
                      ...
                      GestureDetector(
                          onTap: () async {
                            ...
                            var request = http.Request(
                                'POST',
                                Uri.parse(
                                    'https://admin.wasiljo.com/public/api/v1/delivery-boy/subcategories/remove/${id.toString()}'));
