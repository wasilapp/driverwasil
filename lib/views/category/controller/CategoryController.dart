...
//   });
  ...
  var request = http.Request('POST',
      Uri.parse('https://news.wasiljo.com/public/api/v1/delivery-boy/subcategories/remove/${id}'));
  request.bodyFields = {};
...
addNewCategory({required String catgId,required String totalamount,required String availableAmount}){
