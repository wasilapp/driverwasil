                              ...
                              children: [
                                ...
                                Text(Translator.translate('Total'),
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        fontSize: 13.sp)),
                                Text('${deliveryBoy!.totalQuantity.toString()}',
                                    style: TextStyle(
                                        color: primaryColor,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 15.sp)),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              children: [
                                Text(Translator.translate('empty'),
                                    style: TextStyle(
                                        color: primaryColor,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11.sp)),
                                Text(
                                    '${(appUserData.data!.deliveryBoy!.totalQuantity! - appUserData.data!.deliveryBoy!.availableQuantity!).toString()}',
                                    style: TextStyle(
                                        color: primaryColor,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 15.sp)),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Center(
                                    child: Text(
                                        Translator.translate('not Empty'),
                                        style: TextStyle(
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 11.sp))),
                                Text(
                                    '${appUserData.data!.deliveryBoy!.availableQuantity!.toString()}',
                                    style: TextStyle(
                                        color: primaryColor,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 15.sp)),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    Translator.translate("car number :"),
                                  ),
                                ],
                              ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    Translator.translate("Type services :"),
                                  ),
                                ],
                              ),
                            ],
