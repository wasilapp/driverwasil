...
class Data {
  ...
  Data({this.deliveryBoy});

  Data.fromJson(Map<String, dynamic> json) {
    deliveryBoy = json['deliveryBoy'] != null ? new DeliveryBoyTransaction.fromJson(json['deliveryBoy']) : null;
  }
...
class DeliveryBoyTransaction {
  ...
  DeliveryBoyTransaction({this.id, this.name, this.agencyName, this.carNumber, this.email, this.emailVerifiedAt, this.password, this.fcmToken, this.latitude, this.longitude, this.isFree, this.isOffline, this.isActive, this.avatarUrl, this.mobile, this.mobileVerified, this.rating, this.totalRating, this.categoryId, this.shopId, this.rememberToken, this.isVerified, this.drivingLicense, this.carLicense, this.isApproval, this.distance, this.otp, this.totalCapacity, this.totalQuantity, this.availableQuantity, this.referrer, this.referrerLink, this.createdAt, this.updatedAt, this.orderTotal, this.orders});

  DeliveryBoyTransaction.fromJson(Map<String, dynamic> json) {
    id = json['id'];
